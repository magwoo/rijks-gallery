  ...
  <div class="flex flex-col md:flex-row gap-4">
    ...
    <div class="flex flex-col w-[720px]">
      ...
      <p class="font-semibold mt-4 text-neutral/75">
        ...
        rem et eveniet? Lorem ipsum dolor sit amet, consectetur adipisicing
        elit. Odio quo similique quibusdam vero molestias assumenda consequatur
        laborum ullam, quas est voluptate quisquam doloremque ipsum deleniti
        fuga. Eligendi accusamus illo ea.
      </p>
    </div>
  </div>
</template>
